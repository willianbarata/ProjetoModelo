...
namespace projFront.Controllers
{
    public class ProdutosController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int? id, [Bind("Codigo,Descricao,Quantidade,Valor")] Produto produto)
        {
        ...
        {
          return (_context.Produtos?.Any(e => e.Codigo == id)).GetValueOrDefault();
        }
    }
}
